...
namespace Tmf.Hunter.Core.Constants
{
    public class ValidationMessages
    {
        ...
        public const string contacts = "contacts cannot be null";
        public const string identityDocuments = "identityDocuments cannot be null";
        public const string id = "Please Enter valid Id";
        public const string documentType = "Please provide valid DocType";
        public const string documentNumber = "Please provide valid document number";
